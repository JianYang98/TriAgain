...
2. 지시서 §F의 orchestrator 후속 질문 2건 (하네스 트랙 별건, 사용자 승인 필요):
   - ~~`config-deploy.md:10-11` "이 영역은 Tier 3" 문구를 좁힐지~~ — ✅ **해소** (`179ae2e`, 2026-08-12
     "머리말에 남은 티어 열거 제거", CodeRabbit 지적 반영). 지금 `:11`은 *"한 티어로 고정돼 있지 않다"*이고
     티어 요약본을 두지 않는다. **08-12에 이미 끝났는데 미결로 남아 있었다** (2026-08-20 확인)
