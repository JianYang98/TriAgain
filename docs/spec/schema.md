...
erDiagram
    ...
    %% (crew_id, user_id) UNIQUE 제약 — V22 (uq_crew_members_crew_id_user_id, 동시 중복가입 안전망)
...
| 제약 | 컬럼 | 설명 |
|------|------|------|
| UNIQUE | (crew_id, user_id) | 동일 유저가 같은 크루에 2번 이상 가입 불가 — V22(uq_crew_members_crew_id_user_id) |
